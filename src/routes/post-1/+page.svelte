<div id="article-container">
	<article>
		...
		<p>
			...
			Tsitsipas) had all lost a slam final from 2 sets up, needing just one more to win the match<a
				id="footnote-ref-1"
		...
		<div class="footnote" id="footnote1">
			1. These players have been dubbed the "little 3" for reasons like this.<a
				href="#footnote-ref-1"><sup>[return]</sup></a
			>
		</div>
	</article>
</div>
